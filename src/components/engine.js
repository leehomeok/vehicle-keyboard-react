...
(function(global, factory) {
   ...
   * 
   * @param {* keyboardType}: number 键盘类型
   *   枚举： {
   *       0: ,
   *       1: ,
   *       2: 
   * }
   * @param {* inputIndex}: number 当前键位Index
   * @param {* presetNumber}: string 预设车牌号码
   * @param {* numberType}: number 车牌号码类型
   */
